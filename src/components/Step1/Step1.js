        ...
        <div className={style.content_persons}>
          <div className={style.content_person}>
            <div className={style.person_gender}>
              <label htmlFor = "male1">
              <input className={style.checkbox_male}
                defaultChecked
                id = "male1"
                type = "radio"
                value = "male"
                ...
                required
              />
                <svg className={style.gender_male} width="40" height="40" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle className={style.male_circle} cx="14.8105" cy="14.8105" r="13.8105" stroke-width="2"/>
              ...
              <label htmlFor = "female1">
                <input className={style.gender_checkbox} className={style.checkbox_female}
                id = "female1"
                type = "radio"
                value = "female"
                name = "sex1"
                ...
                required
                />
                <svg className={style.gender_icon} className={style.gender_female} width="40" height="40" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle className={style.female_circle} cx="14.8105" cy="14.8105" r="13.8105" stroke-width="2"/>
